...
export const airdropTemplate = `Given the recent messages and wallet information below:

{{recentMessages}}

{{walletInfo}}

Extract the following information about the requested airdrop:
- Chain to execute on: Must be one of ["ethereum", "base", ...] (like in viem/chains)
- Amount to airdrop: Must be a string representing the amount in ETH (only number without coin symbol, e.g., "0.1")
- Recipient addresses: Must be valid Ethereum addresses starting with "0x"
- Token symbol or address (if not native token): Optional, leave as null for ETH transfers
